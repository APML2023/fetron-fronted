...
export default function UseAutocomplete(props) {
    ...
    return (
        <div style={{ marginBottom: 16, width: "100%" }}>
            <Root {...getRootProps()} className={focused ? 'Mui-focused ' : ''} style={{ width: "100%" }}>
                <Input {...getInputProps()} className='w-full' onChange={(e) => { setValue(value => e.target.value); getAutoFill(e.target.value); }} />
            </Root>
            {opt.length > 0 && (
